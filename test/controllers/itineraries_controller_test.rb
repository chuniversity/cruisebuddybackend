...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { name: @itinerary.name, ship_id: @itinerary.ship_id, voyage_port_id: @itinerary.voyage_port_id } }, as: :json
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { name: @itinerary.name, ship_id: @itinerary.ship_id, voyage_port_id: @itinerary.voyage_port_id } }, as: :json
    assert_response 200
  end
